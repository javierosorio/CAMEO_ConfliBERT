...
ggsave(here("graphs","fkappa__dis_round1.pdf"), width = 8, height = 4)
...
ggsave(here("graphs","fkappa__dis_round2.pdf"), width = 8, height = 4)
...
ggsave(here("graphs","fkappa__dis_round3.pdf"), width = 8, height = 4)
