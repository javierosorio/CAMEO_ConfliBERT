...
df.rounds <- data.frame(
  round = c("round 1","round 2","round 3","round 4","round 5"),
  relevant = c(k.rel.r1, k.rel.r2, k.rel.r3, k.rel.r4,k.rel.r5),
  penta = c(k.penta.r1, k.penta.r2, k.penta.r3, k.penta.r4, k.penta.r5),
  cameo = c(k.cameo.r1, k.cameo.r2, k.cameo.r3, k.cameo.r4, k.cameo.r5))
...
ggsave(here("graphs","fkappa_dis_rounds_1_5.pdf"), width = 8, height = 4)

ggsave(here("graphs","fkappa_dis_rounds_1_5_small.pdf"), width = 4, height = 2)
