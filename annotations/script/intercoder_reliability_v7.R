...
df.rounds <- data.frame(
  round = c("round 1","round 2","round 3","round 4","round 5","round 6", "round 7"),
  relevant = c(k.rel.r1, k.rel.r2, k.rel.r3, k.rel.r4,k.rel.r5,k.rel.r6,k.rel.r7),
  penta = c(k.penta.r1, k.penta.r2, k.penta.r3, k.penta.r4, k.penta.r5, k.penta.r6,k.penta.r7),
  cameo = c(k.cameo.r1, k.cameo.r2, k.cameo.r3, k.cameo.r4, k.cameo.r5, k.cameo.r6,k.cameo.r6))
...
ggsave(here("graphs","fkappa_dis_rounds_1_7.pdf"), width = 8, height = 4)

ggsave(here("graphs","fkappa_dis_rounds_1_7_small.pdf"), width = 4, height = 2)
